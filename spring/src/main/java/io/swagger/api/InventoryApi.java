...
public interface InventoryApi {
    ...
    ResponseEntity<Void> addInventory(@ApiParam(value = "" ,required=true) @RequestHeader(value="Request-ID", required=true) String requestID
...
,@ApiParam(value = "" ) @RequestHeader(value="Accept", required=false) String accept
    ...
    ResponseEntity<List<InventoryItem>> searchInventory(@ApiParam(value = "" ,required=true) @RequestHeader(value="Request-ID", required=true) String requestID
