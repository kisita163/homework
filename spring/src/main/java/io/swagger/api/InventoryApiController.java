...
public class InventoryApiController implements InventoryApi {
    ...
    public ResponseEntity<Void> addInventory(@ApiParam(value = "" ,required=true) @RequestHeader(value="Request-ID", required=true) String requestID
,@ApiParam(value = "Inventory item to add"  )  @Valid @RequestBody InventoryItem body
,@ApiParam(value = "" ) @RequestHeader(value="Accept", required=false) String accept
    ...
    public ResponseEntity<List<InventoryItem>> searchInventory(@ApiParam(value = "" ,required=true) @RequestHeader(value="Request-ID", required=true) String requestID
,@ApiParam(value = "pass an optional search string for looking up inventory") @Valid @RequestParam(value = "searchString", required = false) String searchString
